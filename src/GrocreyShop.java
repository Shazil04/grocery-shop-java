    ...
    public static void main(String[] args) {
        ...
        if (!purchasedItems.isEmpty()) {
            ...
            for (int i = 0; i < purchasedItems.size(); i++) {
                float totalPrice = purchasedQuantities.get(i) * purchasedPrices.get(i);
                System.out.printf("%-15s %-10d %-15.2f %-10.2f\n",
                        purchasedItems.get(i), purchasedQuantities.get(i), purchasedPrices.get(i), totalPrice);
            }
            System.out.println("=============================\n");
        }
...
>>>>>>> bf000a66959da3526117cb7b27242f66132ccc3c
